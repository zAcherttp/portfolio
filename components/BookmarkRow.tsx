...
export default function BookmarkRow({ bookmark }: BookmarkRowProps) {
  ...
  return (
    <a
      ...
      className="flex items-center justify-between py-2.5 px-3 rounded-lg hover:bg-zinc-100/70 group"
    >
      ...
      {/* Link / Domain */}
      <div className="flex items-center text-xs text-zinc-400 group-hover:text-zinc-800 font-medium ml-4 flex-shrink-0">
